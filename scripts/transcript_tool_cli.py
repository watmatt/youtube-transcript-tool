#!/usr/bin/env python3
"""
Command-line version of YouTube Transcript Tool
For systems without GUI support (headless servers, etc.)
"""
...
def get_video_title_html(video_url):
    ...
    try:
        ...
        if title_tag:
            ...
            title = re.sub(r'-+', '-', title)  # Replace multiple dashes
...
def main():
    print("=== YouTube Transcript Tool (Command Line) ===")
    print()
    ...
    try:
        ...
        if video_title:
            ...
            if os.path.exists(filename):
                ...
                print(f"✓ Transcript file renamed to: {os.path.basename(new_filename)}")
